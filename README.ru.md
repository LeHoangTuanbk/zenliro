...
- **Стилевые пресеты** — 40+ кураторских образов для разных настроений и жанров.
...
- [ ] Исправление ошибок
- [x] Добавить более качественные функции управления фотографиями и удобные горячие клавиши
